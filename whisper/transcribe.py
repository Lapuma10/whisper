...
def cli():
    ...
    parser.add_argument("--device", default="cuda" if torch.cuda.is_available() else ("xpu" if hasattr(torch, 'xpu') and torch.xpu.is_available() else "cpu"), help="device to use for PyTorch inference")
